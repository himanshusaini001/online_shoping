  <div class="container-fluid bg-dark text-secondary mt-5 pt-5">
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                ...
                <p class="mb-2"><i class="fa fa-thumb-tack mr-3" style="color:#f9d44c"  aria-hidden="true" ></i>Panchkula</p>
                <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>Technoarray@gmail.com</p>
                <p class="mb-0"><i class="fa fa-phone mr-3" style="color:#f9d44c"></i>+012 345 67890</p>
            </div>
            <div class="col-lg-8 col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-5">
                        ...
                        <div class="d-flex">
                            <a class="btn btn-primary btn-square mr-2" href="https://twitter.com/i/flow/login"><i class="fab fa-twitter"></i></a>
                            <a class="btn btn-primary btn-square mr-2" href="https://www.facebook.com/"><i class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-primary btn-square mr-2" href="https://in.linkedin.com/"><i class="fab fa-linkedin-in"></i></a>
